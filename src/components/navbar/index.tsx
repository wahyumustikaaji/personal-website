                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-32">
                        <div className="flex items-center gap-1">
                            <a href="#" className="text-lg text-black font-medium">Projects,</a>
                            <a href="#" className="text-lg text-black font-medium">About,</a>
                            <a href="https://medium.com/@wahyuma123" className="text-lg text-black font-medium">Blog</a>
                        </div>
                        <a href="mailto:wahyuma123@gmail.com" className="text-lg text-black font-medium">wahyuma123@gmail.com</a>
                    </div>
                </div>
            </div>
        </nav>
